...
"font: 20pt \"Cute Jellyfish\";"));
        img = new QLabel(GameView);
        img->setObjectName(QString::fromUtf8("img"));
        img->setGeometry(QRect(80, 140, 251, 221));
        img->setPixmap(QPixmap(QString::fromUtf8(":/imagens/nova img - mudar transparencia.jpg")));
        img->setScaledContents(true);
        mask = new QLabel(GameView);
        mask->setObjectName(QString::fromUtf8("mask"));
        mask->setGeometry(QRect(80, 140, 251, 221));
        mask->setStyleSheet(QString::fromUtf8("background: rgb(0, 0, 0, 0.9)"));
    ...
    void retranslateUi(QDialog *GameView)
    {
        ...
        img->setText(QString());
        mask->setText(QApplication::translate("GameView", "TextLabel", nullptr));
    } // retranslateUi
